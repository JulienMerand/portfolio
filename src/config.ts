export const siteConfig = {
  ...
  aboutMe:
    "As a 25-year-old PhD student at CEA-List and Paris-Saclay University, I specialize in the intersection of Vision-Based Policy Learning and Dexterous Manipulation. My research aims to bridge the gap between high-level AI reasoning and low-level robotic control to achieve human-like hand coordination. I combine a strong theoretical foundation with a hands-on commitment to shaping the future of intelligent robotics. Beyond my academic research, I am a big sports fan (runner, cyclist, black-belt judoka) and a guitarist.",
  skills: [
    "Python", 
    "C/C++", 
    "PyTorch", 
  ...
  projects: [
    {
      ...
      description:
        "Ungoing personal project inspired by BCN3D's Moveo robot. Developed various kinematics and control applications in Python and C++ on ROS2 Humble.",
    ...
    {
      name: "Analog Guitar Effects Pedal",
      description:

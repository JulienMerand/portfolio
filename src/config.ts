export const siteConfig = {
  ...
  aboutMe:
    "As a 25-year-old PhD student at CEA-List and Paris-Saclay University, I specialize in the intersection of Vision-Based Policy Learning and Dexterous Manipulation. My research at CEA-List aims to bridge the gap between high-level AI reasoning and low-level robotic control to achieve human-like hand coordination. I combine a strong theoretical foundation with a hands-on commitment to shaping the future of intelligent robotics. Beyond my academic research, I am a big sports fan (runner, cyclist, black-belt judoka) and a guitarist.",
  skills: ["Python", "Pytorch", "ROS/ROS2", "C/C++", "Linux", "Git"],
  experience: [
    {
      company: "CEA-List",
      ...
      bullets: [
        "Subject: Vision-Based Policy Learning for Dexterous Multi-Fingered Robotic Manipulation",
      ],
    },
    {
      company: "CEA-List",
      ...
      bullets: [
        "Used vision and AI tools to recognize and locate everyday objects for performing grips, seizures and other robotic handling tasks with a two-armed exoskeleton and an eye tracking device for active assistance.",
      ],
    },
    {
  ...
  education: [
    ...
    },
    {
      ...
      degree: "Engineering School (MSc Eng)",
      dateRange: "2021 - 2024",
      achievements: [
        "Studied Autonomous and Industrial Robotics, Automatics, and Project Management",
        "Served as Project Manager for a weather balloon launch and Show Manager for the GALA",
      ],
    },
  ],
  papers: [
    {
      ...
      abstract: "",
      tags: ["Robotics", "AI", "Dexterous Manipulation", "Grasps Synthesis"], 
    },
    {
      title: "Coming Soon...",
      authors: "",
    ...
    },
    {
      ...
      tags: ["Robotics", "AI", "Point Cloud", "Joint Configuration"], 
    },
  ],
  projects: [
    {
      ...
      description:
        "Personnal project inspired by BCN3D's Moveo robot. Developed various applications in Python and C++ on ROS2 Humble.",
    ...
    },
    {
      ...
      description:
        "This project proposes a dynamic obstacle avoidance solution for mobile robots, leveraging machine learning for velocity estimation and cost mapping.",
      // link: "",
      skills: ["ROS2", "Python", "C/C++", "Computer Vision"],
    },
    {
      name: "Guitar Effects Pedal Fabrication",
      description:
    ...
    },
    {
      ...
      description:
        "Wrote algorithms on a product for learning Braille in a fun way. The project has now become an independant company.",
